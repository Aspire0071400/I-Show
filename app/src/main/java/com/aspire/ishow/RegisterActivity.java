        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String email = register_email_tied.getText().toString(),
                        ...
                        bio = register_bio_tied.getText().toString();
                ...
                if(email.isEmpty()){
                    ...
                    Toast.makeText(RegisterActivity.this,"Fill Profession/Bio",Toast.LENGTH_SHORT).show();
                    ...
                    auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                User user = new User(name, bio, email, password);
